        ...
        <v-carousel 
          ...
          <v-row class="fill-height" justify="center" align="center">
            <v-col cols="12" class="text-center">
               <div class="d-block display-3 font-weight-black"><span class="titulo-logo-orange titulo-logo">BINGO</span><span class="titulo-logo-green titulo-logo">LIN</span></div> 
...
export default {
  ...
  created()
  {
    this.banners = JSON.parse(window.images).filter( image => image.id_tipo_foto == 1 )
  },
