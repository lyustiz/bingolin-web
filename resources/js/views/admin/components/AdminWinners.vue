   ...
   <v-card>
       <v-card-title class="grey lighten-4">
           <v-row>
             ...
             <v-col cols="auto">
                <AppFoto :tipo-foto="5" @storeImage="list()"></AppFoto>
             </v-col>
           </v-row>
       </v-card-title>
       <v-card-text>
          ...
          <v-container>
          <v-img v-for="foto in fotos" :key="foto.id" :src="foto.full_url" :aspect-ratio="5/3" class="my-4 elevation-6 rounded-lg col-12 col-md-6 mx-auto">
            <v-row
              class="fill-height"
              align="center"
              justify="center"
